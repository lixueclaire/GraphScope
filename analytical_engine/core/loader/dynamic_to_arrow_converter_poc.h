...
#ifndef ANALYTICAL_ENGINE_CORE_LOADER_DYNAMIC_TO_ARROW_CONVERTER_POC_H_
#define ANALYTICAL_ENGINE_CORE_LOADER_DYNAMIC_TO_ARROW_CONVERTER_POC_H_
 ...
 */
template <typename T>
struct VertexArrayBuilderPoc {};

/**
 * @brief This is a specialized VertexArrayBuilder for arrow::Int64Builder
 */
template <>
struct VertexArrayBuilderPoc<arrow::Int64Builder> {
  static bl::result<std::shared_ptr<arrow::Array>> build(
      const std::shared_ptr<grape::DynamicFragmentPoc>& src_frag, std::string& prop_key) {
 ...
 */
template <>
struct VertexArrayBuilderPoc<arrow::DoubleBuilder> {
  static bl::result<std::shared_ptr<arrow::Array>> build(
      const std::shared_ptr<grape::DynamicFragmentPoc>& src_frag, std::string& prop_key) {
 ...
 */
template <>
struct VertexArrayBuilderPoc<arrow::LargeStringBuilder> {
  static bl::result<std::shared_ptr<arrow::Array>> build(
      const std::shared_ptr<grape::DynamicFragmentPoc>& src_frag, std::string& prop_key) {
 ...
 */
template <typename T>
struct EdgeArrayBuilderPoc {};

/**
 * @brief This is a specialized EdgeArrayBuilder for arrow::Int64Builder
 */
template <>
struct EdgeArrayBuilderPoc<arrow::Int64Builder> {
  static bl::result<std::shared_ptr<arrow::Array>> build(
      const std::shared_ptr<grape::DynamicFragmentPoc>& src_frag, std::string& prop_key) {
 ...
 */
template <>
struct EdgeArrayBuilderPoc<arrow::DoubleBuilder> {
  static bl::result<std::shared_ptr<arrow::Array>> build(
      const std::shared_ptr<grape::DynamicFragmentPoc>& src_frag, std::string& prop_key) {
    auto inner_vertices = src_frag->InnerVertices();
    arrow::DoubleBuilder builder;
 ...
 */
template <>
struct EdgeArrayBuilderPoc<arrow::LargeStringBuilder> {
  static bl::result<std::shared_ptr<arrow::Array>> build(
      const std::shared_ptr<grape::DynamicFragmentPoc>& src_frag, std::string& prop_key) {
    auto inner_vertices = src_frag->InnerVertices();
    arrow::LargeStringBuilder builder;
...
struct COOBuilderPoc<DST_FRAG_T, int64_t> {
  using oid_t = int64_t;
  using src_fragment_t = grape::DynamicFragmentPoc;
 ...
 */
template <typename DST_FRAG_T>
struct COOBuilderPoc<DST_FRAG_T, std::string> {
  using oid_t = int64_t;
  using src_fragment_t = grape::DynamicFragmentPoc;
  using dst_fragment_t = DST_FRAG_T;
...
struct VertexMapConverterPoc {};

/**
 * @brief This is a specialized VertexMapConverter for int64_t
 */
template <>
class VertexMapConverterPoc<int64_t> {
  using oid_t = int64_t;
  using origin_oid_t = typename grape::DynamicFragmentPoc::oid_t;
  using vid_t = typename grape::DynamicFragmentPoc::vid_t;
  using oid_array_t = typename vineyard::ConvertToArrowType<oid_t>::ArrayType;
  using oid_builder_t =
      typename vineyard::ConvertToArrowType<oid_t>::BuilderType;

 public:
  explicit VertexMapConverterPoc(const grape::CommSpec& comm_spec,
                              vineyard::Client& client)
      : comm_spec_(comm_spec), client_(client) {}

  bl::result<vineyard::ObjectID> Convert(
      const std::shared_ptr<grape::DynamicFragmentPoc>& dynamic_frag) {
 ...
 */
template <>
class VertexMapConverterPoc<std::string> {
 ...
 */
template <typename OID_T>
class DynamicToArrowConverterPoc {
  using src_fragment_t = grape::DynamicFragmentPoc;
  using oid_t = OID_T;
 ...
 public:
  DynamicToArrowConverterPoc(const grape::CommSpec& comm_spec,
                          vineyard::Client& client)
      : comm_spec_(comm_spec), client_(client) {}

  bl::result<std::shared_ptr<dst_fragment_t>> Convert(
      const std::shared_ptr<src_fragment_t>& dynamic_frag) {
    VertexMapConverterPoc<oid_t> converter(comm_spec_, client_);
 ...
 private:
  ...
  bl::result<std::shared_ptr<arrow::Table>> buildVTable(
    ...
    for (const auto& p : prop_keys) {
      ...
      case dynamic::Type::kInt64Type: {
        auto r = VertexArrayBuilderPoc<arrow::Int64Builder>::build(src_frag, key);
      ...
      case dynamic::Type::kDoubleType: {
        auto r = VertexArrayBuilderPoc<arrow::DoubleBuilder>::build(src_frag, key);
      ...
      case dynamic::Type::kStringType: {
        auto r =
            VertexArrayBuilderPoc<arrow::LargeStringBuilder>::build(src_frag, key);
  ...
  bl::result<std::shared_ptr<arrow::Table>> buildETable(
    ...
    auto inner_vertices = src_frag->InnerVertices();
    COOBuilderPoc<dst_fragment_t, oid_t> builder;
    ...
    for (const auto& e : prop_keys) {
      ...
      switch (type) {
      case dynamic::Type::kInt64Type: {
        auto r = EdgeArrayBuilderPoc<arrow::Int64Builder>::build(src_frag, key);
      ...
      case dynamic::Type::kDoubleType: {
        auto r = EdgeArrayBuilderPoc<arrow::DoubleBuilder>::build(src_frag, key);
      ...
      case dynamic::Type::kStringType: {
        auto r =
            EdgeArrayBuilderPoc<arrow::LargeStringBuilder>::build(src_frag, key);
...
#endif
#endif  // ANALYTICAL_ENGINE_CORE_LOADER_DYNAMIC_TO_ARROW_CONVERTER_POC_H_

...
#ifndef ANALYTICAL_ENGINE_APPS_FLASH_TAILED_TRIANGLE_H_
#define ANALYTICAL_ENGINE_APPS_FLASH_TAILED_TRIANGLE_H_
...
#endif  // ANALYTICAL_ENGINE_APPS_FLASH_TAILED_TRIANGLE_H_
